...
const FormPost = () => {
    ...
    const animeaux=["Chien", "chat", "Poisson"];
    const aliment=[ "croquettee", "pate"];
    const accesoires=["jouet", "laisse"];
    const categories=[[],  animeaux, aliment, accesoires];
